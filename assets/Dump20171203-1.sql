...
INSERT INTO `days_exercises` VALUES (3,1,3,42,45),(4,2,3,NULL,NULL),(5,3,3,0,0),(6,4,3,0,0);
...
INSERT INTO `routines` VALUES (2,1,'Rutina Ivan'),(10,1,'Pedro'),(11,1,'Mi rutina'),(12,1,'Mi rutina 2'),(13,1,'Holaa');
...
CREATE TABLE `users` (
  ...
  `weigh` int(3) DEFAULT NULL,
  `weigh_unit` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `users` VALUES (1,'Ivan','Gónzalez Hernández','ivanglez1996@gmail.com','pepe','male',25,'IvanGlez1996',56,'kg'),(2,'pepe','pepe','pepe@pepe.com','Pepepepe1','hombre',465,'pepe',454,'kg');
...
-- Dump completed on 2017-12-03 22:56:34
